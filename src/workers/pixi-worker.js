...
import { Transform } from "../core/premade-components/transform.js";
import { RigidBody } from "../core/premade-components/rigid-body.js";
import { Collider } from "../core/premade-components/collider.js";
import { SpriteRenderer } from "../core/premade-components/sprite-renderer.js";
import { ParticleComponent } from "../core/premade-components/particle-component.js";
import { DecorationComponent } from "../core/premade-components/decoration-component.js";
import { DecorationPool } from "../core/decoration-pool.js";
import { SpriteSheetRegistry } from "../core/sprite-sheet-registry.js";
import { AbstractWorker } from "./abstract-worker.js";
import { DEBUG_FLAGS } from "../core/debugging-stuff/debug-flags.js";
import { Mouse } from "../core/singleton-classes/mouse.js";
import { MouseComponent } from "../core/premade-components/mouse-component.js";
import { LightEmitter } from "../core/premade-components/light-emitter.js";
import { Grid } from "../core/singleton-classes/grid.js";
import { Ray } from "../core/singleton-classes/ray.js";
import {
  drawLine,
  drawCircle,
  drawCross,
  sortByY,
} from "../core/game-utils.js";
import { RENDERER_STATS, createStatsWriter } from "./worker-utils.js";
...
import {
  ...
  GlProgram,
  extensions,
} from "../lib/pixi8webworker.js";
import { convertRGBtoBGR } from "../core/game-utils.js";
...
===================== */
  ...
  createLightGlowSystem() {
    ...
    this.lightGlowContainer.name = "lightGlowContainer";
