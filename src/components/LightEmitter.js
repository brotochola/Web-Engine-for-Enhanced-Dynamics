...
export class LightEmitter extends Component {
  static ARRAY_SCHEMA = {
    ...
    squaredLightIntensity: Float32Array,
    height: Float32Array,
   ...
   * OPTIMIZED: Automatically updates squaredLightIntensity to avoid repeated sqrt calculations
  ...
  set lightIntensity(value) {
    ...
    LightEmitter.squaredLightIntensity[this.index] = Math.sqrt(value);
  }
}
