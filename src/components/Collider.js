/**
 * @fileoverview Collision component for entity collision detection
 * Supports circles, boxes, and collision filtering
 * @see {@link WEED.types.ColliderProperties} for property type definitions
 */
//
...
class Collider extends Component {
  ...
  // Properties are TypedArrays indexed by entity index: Collider.radius[entityIndex]
  ...
  /** @type {number} Shape type (0=Circle, 1=Box, 2=Polygon) */
  shapeType;
  /** @type {number} Perception range for spatial queries */
  visualRange;

  /** @type {number} Offset X from entity position */
  offsetX;
  /** @type {number} Offset Y from entity position */
  offsetY;
