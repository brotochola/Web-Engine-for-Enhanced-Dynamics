...
async function createWasm() {
  ...
  function receiveInstance(instance, module) {
    ...
    registerTLSInit(wasmExports["Vc"]);
...
function assignWasmExports(wasmExports) {
  ...
  _get_particle_user_data_byte_offset = Module["_get_particle_user_data_byte_offset"] = wasmExports["Bc"];
  _get_particle_color_byte_offset = Module["_get_particle_color_byte_offset"] = wasmExports["Cc"];
  _get_particle_viscous_scale_byte_offset = Module["_get_particle_viscous_scale_byte_offset"] = wasmExports["Dc"];
  _set_particle_user_data = Module["_set_particle_user_data"] = wasmExports["Ec"];
  _set_particle_user_data_range = Module["_set_particle_user_data_range"] = wasmExports["Fc"];
  _set_particle_color = Module["_set_particle_color"] = wasmExports["Gc"];
  _set_particle_color_range = Module["_set_particle_color_range"] = wasmExports["Hc"];
  _set_particle_flags = Module["_set_particle_flags"] = wasmExports["Ic"];
  _set_particle_viscous_scale = Module["_set_particle_viscous_scale"] = wasmExports["Jc"];
  _set_particle_viscous_scale_range = Module["_set_particle_viscous_scale_range"] = wasmExports["Kc"];
  _set_particle_group_flags = Module["_set_particle_group_flags"] = wasmExports["Lc"];
  _destroy_particle = Module["_destroy_particle"] = wasmExports["Mc"];
  _create_particle = Module["_create_particle"] = wasmExports["Nc"];
  _particle_apply_force_range = Module["_particle_apply_force_range"] = wasmExports["Oc"];
  _particle_apply_linear_impulse_range = Module["_particle_apply_linear_impulse_range"] = wasmExports["Pc"];
  _set_particle_extra_tuning = Module["_set_particle_extra_tuning"] = wasmExports["Qc"];
  _get_extract_indices_byte_offset = Module["_get_extract_indices_byte_offset"] = wasmExports["Rc"];
  _get_extract_indices_max = Module["_get_extract_indices_max"] = wasmExports["Sc"];
  _extract_particles = Module["_extract_particles"] = wasmExports["Tc"];
  _weedjs_heap_bytes_used = Module["_weedjs_heap_bytes_used"] = wasmExports["Uc"];
  __emscripten_tls_init = wasmExports["Vc"];
  _pthread_self = wasmExports["Wc"];
  __emscripten_thread_init = wasmExports["Yc"];
  ___set_thread_state = wasmExports["Zc"];
  __emscripten_thread_crashed = wasmExports["_c"];
  __emscripten_run_js_on_main_thread_done = wasmExports["$c"];
  __emscripten_run_js_on_main_thread = wasmExports["ad"];
  __emscripten_thread_free_data = wasmExports["bd"];
  __emscripten_thread_exit = wasmExports["cd"];
  __emscripten_timeout = wasmExports["dd"];
  __emscripten_check_mailbox = wasmExports["ed"];
  _emscripten_stack_set_limits = wasmExports["fd"];
  __emscripten_stack_restore = wasmExports["gd"];
  __emscripten_stack_alloc = wasmExports["hd"];
  _emscripten_stack_get_current = wasmExports["id"];
  __indirect_function_table = wasmTable = wasmExports["Xc"];
}
