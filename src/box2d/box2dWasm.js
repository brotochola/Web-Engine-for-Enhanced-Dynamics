...
async function createWasm() {
  ...
  function receiveInstance(instance, module) {
    ...
    registerTLSInit(wasmExports["Zc"]);
...
function assignWasmExports(wasmExports) {
  ...
  _get_particle_capacity = Module["_get_particle_capacity"] = wasmExports["uc"];
  _get_particle_radius = Module["_get_particle_radius"] = wasmExports["vc"];
  _get_particle_count_byte_offset = Module["_get_particle_count_byte_offset"] = wasmExports["wc"];
  _get_particle_pos_byte_offset = Module["_get_particle_pos_byte_offset"] = wasmExports["xc"];
  _get_particle_vel_byte_offset = Module["_get_particle_vel_byte_offset"] = wasmExports["yc"];
  _get_particle_flags_byte_offset = Module["_get_particle_flags_byte_offset"] = wasmExports["zc"];
  _get_particle_x_byte_offset = Module["_get_particle_x_byte_offset"] = wasmExports["Ac"];
  _get_particle_alpha_byte_offset = Module["_get_particle_alpha_byte_offset"] = wasmExports["Bc"];
  _get_particle_y_byte_offset = Module["_get_particle_y_byte_offset"] = wasmExports["Cc"];
  _get_particle_vx_byte_offset = Module["_get_particle_vx_byte_offset"] = wasmExports["Dc"];
  _get_particle_vy_byte_offset = Module["_get_particle_vy_byte_offset"] = wasmExports["Ec"];
  _get_particle_user_data_byte_offset = Module["_get_particle_user_data_byte_offset"] = wasmExports["Fc"];
  _get_particle_color_byte_offset = Module["_get_particle_color_byte_offset"] = wasmExports["Gc"];
  _get_particle_viscous_scale_byte_offset = Module["_get_particle_viscous_scale_byte_offset"] = wasmExports["Hc"];
  _set_particle_user_data = Module["_set_particle_user_data"] = wasmExports["Ic"];
  _set_particle_user_data_range = Module["_set_particle_user_data_range"] = wasmExports["Jc"];
  _set_particle_color = Module["_set_particle_color"] = wasmExports["Kc"];
  _set_particle_color_range = Module["_set_particle_color_range"] = wasmExports["Lc"];
  _set_particle_flags = Module["_set_particle_flags"] = wasmExports["Mc"];
  _set_particle_viscous_scale = Module["_set_particle_viscous_scale"] = wasmExports["Nc"];
  _set_particle_viscous_scale_range = Module["_set_particle_viscous_scale_range"] = wasmExports["Oc"];
  _set_particle_group_flags = Module["_set_particle_group_flags"] = wasmExports["Pc"];
  _destroy_particle = Module["_destroy_particle"] = wasmExports["Qc"];
  _create_particle = Module["_create_particle"] = wasmExports["Rc"];
  _particle_apply_force_range = Module["_particle_apply_force_range"] = wasmExports["Sc"];
  _particle_apply_linear_impulse_range = Module["_particle_apply_linear_impulse_range"] = wasmExports["Tc"];
  _set_particle_extra_tuning = Module["_set_particle_extra_tuning"] = wasmExports["Uc"];
  _get_extract_indices_byte_offset = Module["_get_extract_indices_byte_offset"] = wasmExports["Vc"];
  _get_extract_indices_max = Module["_get_extract_indices_max"] = wasmExports["Wc"];
  _extract_particles = Module["_extract_particles"] = wasmExports["Xc"];
  _weedjs_heap_bytes_used = Module["_weedjs_heap_bytes_used"] = wasmExports["Yc"];
  __emscripten_tls_init = wasmExports["Zc"];
  _pthread_self = wasmExports["_c"];
  __emscripten_thread_init = wasmExports["ad"];
  ___set_thread_state = wasmExports["bd"];
  __emscripten_thread_crashed = wasmExports["cd"];
  __emscripten_run_js_on_main_thread_done = wasmExports["dd"];
  __emscripten_run_js_on_main_thread = wasmExports["ed"];
  __emscripten_thread_free_data = wasmExports["fd"];
  __emscripten_thread_exit = wasmExports["gd"];
  __emscripten_timeout = wasmExports["hd"];
  __emscripten_check_mailbox = wasmExports["id"];
  _emscripten_stack_set_limits = wasmExports["jd"];
