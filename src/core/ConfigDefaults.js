...
export const RENDERER_DEFAULTS = {
  ...
  cullingRatio: 0.1,
  /** Use spatial grid for entity visibility (fewer iterations in sparse scenes). False = iterate all active (faster for dense scenes). */
  useGridForEntityVisibility: false,
