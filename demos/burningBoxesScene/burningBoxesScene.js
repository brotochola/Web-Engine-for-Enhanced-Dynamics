      ...
      fire: {
        ...
        shader: {
          ...
          uniforms: {
            ...
            uStampPad: { value: 0, type: 'f32', min: -30, max: 30, step: 0.25, label: 'Stamp pad', tip: 'Solid stamp inset/outset for floors and unlit boxes, in grid cells. 0 = collider edge. Burning boxes use Stamp inner/outer instead.' },
            uSolidPush: { value: 200, type: 'f32', min: 0, max: 2000, step: 10, label: 'Solid push', tip: 'Outward kick from floors and unlit wood. Burning bodies skip this so they do not blow their own flames away. 0 = off.' },
