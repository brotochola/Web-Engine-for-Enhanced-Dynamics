...
export const ENGINE_FEATURES = [
  ...
  },
  {
    ...
    scene: {
      key: 'decoQueryCircle',
      path: '/tests/bench/stressScenes/decoQueryCircleStressScene.js',
      exportName: 'DecoQueryCircleStressScene',
      headed: false,
      kind: 'stress',
    },
    primary: ['logic0_STEP_MS'],
  ...
  },
  {
    ...
    scene: {
      ...
      exportName: 'DecalBlitStressScene',
      headed: false,
      kind: 'stress',
    },
    primary: ['pixi_STEP_MS'],
  ...
  },
  {
    id: 'sceneryCam',
    name: 'Scenery camera',
    module: 'src/render/sceneryCamPack.js',
    kernel: { script: 'tests/bench/sceneryCamMicrobench.mjs', opsKey: 'pack.opsPerSec' },
    scene: {
      key: 'sceneryCam',
      path: '/tests/bench/stressScenes/sceneryCamStressScene.js',
      exportName: 'SceneryCamStressScene',
      headed: false,
      kind: 'stress',
    },
    primary: ['pixi_STEP_MS'],
  ...
  {
    id: 'meshFillMoving',
    name: 'MESH fill moving pack',
    module: 'src/render/colliderFillBatch.js',
    kernel: { script: 'tests/bench/colliderFillPackMicrobench.mjs', opsKey: 'B.opsPerSec' },
    scene: {
      key: 'meshFillMoving',
      path: '/tests/bench/stressScenes/meshFillMovingScene.js',
      exportName: 'MeshFillMovingScene',
      headed: false,
      kind: 'stress',
    },
    primary: ['pixi_STEP_MS'],
  ...
  {
    id: 'meshFillPan',
    name: 'MESH fill camera pan',
    module: 'src/render/meshFillCamera.js',
    kernel: { script: 'tests/bench/meshCameraUniformMicrobench.mjs', opsKey: 'timed.opsPerSec' },
    scene: {
      key: 'meshFillPan',
      path: '/tests/bench/stressScenes/meshFillPanScene.js',
      exportName: 'MeshFillPanScene',
      headed: false,
      kind: 'stress',
    },
    primary: ['pixi_STEP_MS'],
  ...
  },
  {
    id: 'meshFillLook',
    name: 'MESH look pan',
    module: 'src/render/meshLookUv.js',
    kernel: null,
    scene: {
      key: 'meshFillLook',
      path: '/tests/bench/stressScenes/meshFillLookPanScene.js',
      exportName: 'MeshFillLookPanScene',
      headed: false,
      kind: 'stress',
    },
    primary: ['pixi_STEP_MS'],
